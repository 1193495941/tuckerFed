...
import tucker
import fedbuff
import flgo.benchmark.svhn_classification.model.resnet34 as resnet34
import flgo.benchmark.svhn_classification.model.cnn as cnn
...
num_clients = 20
data_columns_name = f'svhn_data_columns_{num_clients}.json'
task = f'./svhn_result_{num_clients}'
gen_config = {
    'benchmark': {'name': 'flgo.benchmark.svhn_classification'},
    'partitioner': {
        'name': 'IIDPartitioner',
        'para': {
