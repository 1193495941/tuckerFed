...
import tucker
import fedbuff
import flgo.benchmark.cifar100_classification.model.cnn as cnn
import flgo.benchmark.cifar100_classification.model.resnet50 as resnet50
...
num_clients = 30
task = f'./cifar100_result_{num_clients}'
data_columns_name = f'cifar100_data_columns_{num_clients}.json'
gen_config = {
    'benchmark': {'name': 'flgo.benchmark.cifar100_classification'},
    'partitioner': {
        'name': 'IIDPartitioner',
        'para': {
